...
# 16S rRNA gene amplicon quantification 
```{r plot 16S ddPCR quantification data, fig.height=5, fig.width=8}
#data prep
...
```{r hypothesis testing for 16S ddPCR quantification , echo = TRUE, results = 'hide'}
